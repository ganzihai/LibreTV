...
function renderRecommend(tag, pageLimit, pageStart) {
    ...
    const target = `${DOUBAN_API_PROXY}/j/search_subjects?type=${doubanMovieTvCurrentSwitch}&tag=${encodeURIComponent(tag)}&sort=recommend&page_limit=${pageLimit}&page_start=${pageStart}`;
...
function handleDoubanImgError(img) {
